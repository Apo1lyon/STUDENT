...
# Для первой библиотеки прописываем также псевдоним  
...
def command():  
    ...
    with sr.Microphone() as source:  
        ...
        # используемadjust_for_ambient_noise дляудаления  
    ...
    # Если не смогли распознать текст, то будет вызвана эта ошибка  
        ...
        # и вызываем снова функцию command() для        # получения текста от пользователя  
        talk("Я вас не поняла")  
  
        zadanie = command()  
        # В конце функции возвращаем текст задания  
        # или же повторный вызов функции    return zadanie  
